...
\usepackage[SYSU,en]{collegeBeamer}
\usepackage{xeCJK}

% meta-data
\title{Beamer Template For \\ Sun Yat-sen University}
\subtitle{Using \LaTeX\ to prepare slides}
\author{\href{mailto:lulietlyan@gmail.com}{Jueming Liang}}
\date{Created 18 May 2025\\Updated 18 May 2025}
...
\begin{document}
    ...
    \begin{frame}{About this template}
        \begin{itemize}
            \item Official template following SYSU visual identity guidelines about how to use \LaTeX\ and beamer to prepare slides.
            \item Licensed under \bhref{https://github.com/LulietLyan/SYSU-Beamer/blob/main/LICENSE}{MIT LICENSE}
            \item Latest version available at \bhref{https://github.com/LulietLyan/SYSU-Beamer}{SYSU LaTeX GitHub}
        \end{itemize}
    \end{frame}
...
% ...
\includegraphics
[width=\textwidth]{src/SYSU/color-logo.pdf}
                    \end{lstlisting}
                \end{block}
            \end{column}
            \begin{column}{0.3\textwidth}
                \vskip5pt\includegraphics[width=\textwidth]{src/SYSU/color-logo.pdf}
            \end{column}
        \end{columns}
    \end{frame}
...
\end{columns}\end{lstlisting}
    ...
    \begin{frame}
        ...
        \begin{itemize}
            \item Template Repository: \bhref{https://github.com/LulietLyan/SYSU-Beamer}{LulietLyan/SYSU-Beamer}
            \item Enough for an introduction! You should know enough by now
            \item If you have corrections or suggestions, \bhref{mailto:lulietlyan@gmail.com}{send them to me!}
        \end{itemize}
    \end{frame}
